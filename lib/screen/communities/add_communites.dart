...
class AddCommunities extends StatefulWidget {
  String communityId;
  AddCommunities({super.key, required this.communityId});
...
class _AddCommunitiesState extends State<AddCommunities> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text("Add Communitie")),
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        showMessageBar("Feed Posted in Community", context);
